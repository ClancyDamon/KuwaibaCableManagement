 ...
 */
package org.neotropic.kuwaiba.modules.optional.pools.visual;
...
public class IconLabelCellGrid extends HorizontalLayout {
     ...
     */
    public IconLabelCellGrid(PoolObjectNode object, boolean isPool, ClassNameIconGenerator iconGenerator) {
        if (isPool) {
