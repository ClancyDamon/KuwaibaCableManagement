 ...
 */
public class ButtonElementUiItem extends AbstractElementUiItem {

    public ButtonElementUiItem(String displayName) {
        super(displayName);
    }
    ...
    public ElementUi create() {
        ...
        buttonElementUi.setElementUiId(UUID.randomUUID().toString());
        buttonElementUi.setElementUiWidth("30px");
        buttonElementUi.setElementUiMinWidth("30px");
        buttonElementUi.setElementUiHeight("33px");
