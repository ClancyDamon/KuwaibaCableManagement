...
public class ProjectsModule extends AbstractModule {
     ...
     * Module id.
     */
    public static final String MODULE_ID = "planning/projects";
    /**
     * Translation service
     */
    @Autowired
    ...
    /**
     * Reference to the action that associate to business object to a project
     */
    @Autowired 
    ...
    public void init() {
        ...
        this.advancedActionsRegistry.registerAction(MODULE_ID, relateObjectToProjectVisualAction);
