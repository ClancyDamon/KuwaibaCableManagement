 ...
 */
public class MultipleMirrorEditor extends AbstractMirrorEditor {
    private final BusinessEntityManager bem;
    private final TranslationService ts;
    
    public MultipleMirrorEditor(PortComponent source, PortComponent target, VerticalLayout lytParent, Command cmdUpdateFreePorts, 
    ...
    protected void onAttach(AttachEvent attachEvent) {
        ...
        ActionButton btnDelete = new ActionButton(
            ...
            ts.getTranslatedString("module.physcon.mirror-man.button.title.release-mirror-multiple")
        );
        btnDelete.addClickListener(clickEvent -> {
            try {
                BusinessObjectLight sourcePort = source.getPort();
                bem.releaseSpecialRelationship(sourcePort.getClassName(), sourcePort.getId(), "-1", "mirrorMultiple"); //NOI18N
                ...
                new SimpleNotification(
                    ...
                    ts.getTranslatedString("module.physcon.mirror-man.notification.info.multiple-mirror-has-been-deleted"), 
        ...
        lyt.add(new PortComponent(source.getPort(), bem, ts), target);
