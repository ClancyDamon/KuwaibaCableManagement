 ...
 */
@Component
public class DeleteLayoutViewVisualAction extends AbstractVisualAction<Dialog> {
    /**
     ...
     */
    @Autowired
    private DeleteLayoutViewAction deleteClassAction;
    /**
    ...
    public DeleteLayoutViewVisualAction() {
    ...
    public Dialog getVisualComponent(ModuleActionParameterSet parameters) {
        ...
        if (parameters.containsKey("viewId")) {
            ...
            ConfirmDialog wdwDeleteClass = new ConfirmDialog(ts, ts.getTranslatedString("module.general.labels.confirmation"),
                    ts.getTranslatedString("module.layout-editor.delete-permanently-view"),
            ...
            wdwDeleteClass.getBtnConfirm().addClickListener((ev) -> {
                try {
                    ...
                    fireActionCompletedEvent(new ActionCompletedListener.ActionCompletedEvent(ActionCompletedListener.ActionCompletedEvent.STATUS_SUCCESS,
                            ts.getTranslatedString("module.layout-editor.actions.view-delete-success"), DeleteLayoutViewAction.class));
                    wdwDeleteClass.close();
                } catch (ModuleActionException ex) {
                    fireActionCompletedEvent(new ActionCompletedListener.ActionCompletedEvent(ActionCompletedListener.ActionCompletedEvent.STATUS_ERROR,
                            ex.getMessage(), DeleteLayoutViewAction.class));
                    wdwDeleteClass.close();
                }
            });
