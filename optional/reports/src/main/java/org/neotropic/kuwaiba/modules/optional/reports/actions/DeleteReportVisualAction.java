 ...
 */
@Component
public class DeleteReportVisualAction extends AbstractVisualAction<Dialog> {
    /**
    ...
    public DeleteReportVisualAction() {
    ...
    public Dialog getVisualComponent(ModuleActionParameterSet parameters) {
        ...
        wdwDeleteClass.getBtnConfirm().addClickListener((ev) -> {
            try {
                ...
                deleteReportAction.getCallback().execute(new ModuleActionParameterSet(
                ...
                fireActionCompletedEvent(new ActionCompletedListener.ActionCompletedEvent(ActionCompletedListener.ActionCompletedEvent.STATUS_ERROR,
                        ex.getMessage(), DeleteReportAction.class));
                wdwDeleteClass.close();
            }
        });
