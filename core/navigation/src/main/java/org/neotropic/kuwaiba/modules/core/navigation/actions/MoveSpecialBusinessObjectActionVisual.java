    ...
    public Dialog getVisualComponent(ModuleActionParameterSet parameters) {
        ...
        if (businessObject != null) {
            ConfirmDialog wdw = new ConfirmDialog(ts,
                    String.format(ts.getTranslatedString("module.navigation.actions.move-special-business-object.header"), businessObject),
                    moveSpecialBusinessObject.getDisplayName());
            wdw.setModal(false);
