    ...
    public Dialog getVisualComponent(ModuleActionParameterSet parameters) {
        ...
        if (parameters.containsKey(PARAM_SYNC_DATA_SOURCE)) {
            ...
            ConfirmDialog wdwDeleteConfiguration = new ConfirmDialog(ts
                    ...
                    , String.format(ts.getTranslatedString("module.sync.actions.delete-sync-data-source-configuration.confirm"), configuration.getName())
            ...
            return new Dialog(new Label(ts.getTranslatedString("module.sync.actions.delete-sync-data-source-configuration.error")));
    }
