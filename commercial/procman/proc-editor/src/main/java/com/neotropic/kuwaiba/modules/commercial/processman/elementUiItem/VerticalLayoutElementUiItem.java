 ...
 */
public class VerticalLayoutElementUiItem extends AbstractElementUiItem {

    public VerticalLayoutElementUiItem(String displayName) {
        super(displayName);
    }
    ...
    public ElementUi create() {
        ...
        verticalLayoutElementUi.setElementUiId(UUID.randomUUID().toString());
        verticalLayoutElementUi.setElementUiWidth("100%");
        verticalLayoutElementUi.setElementUiMinWidth("30px");
        verticalLayoutElementUi.setElementUiHeight("40px");
        
        return verticalLayoutElementUi;
    }
}