 ...
 */
@Component
public class MoveSpecialBusinessObjectAction extends AbstractAction {
    /**
    ...
    @PostConstruct
    protected void init() {
        this.id = "navigation.move-special-business-object"; //NOI18N
        this.displayName = ts.getTranslatedString("module.navigation.actions.move-special-business-object.name");
        this.description = ts.getTranslatedString("module.navigation.actions.move-special-business-object.description");
        this.icon = VaadinIcon.SCISSORS.create();
        setCallback(parameters -> {
            try {
                ...
                objects.put(objectClass, new String[] {objectId});
                
                bem.moveSpecialObjects(targetClass, targetId, objects);
