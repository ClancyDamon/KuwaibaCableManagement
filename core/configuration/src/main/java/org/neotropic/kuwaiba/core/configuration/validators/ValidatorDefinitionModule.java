...
public class ValidatorDefinitionModule extends AbstractModule {
     ...
     * Module id.
     */
    public static final String MODULE_ID = "configuration/validators"; 
    /**
     * Translation service
     */
    @Autowired
    ...
    public String getName() {
        return ts.getTranslatedString("module.configman.validators.name");
    }

    @Override
    public String getDescription() {
        return ts.getTranslatedString("module.configman.validators.description");
    }
