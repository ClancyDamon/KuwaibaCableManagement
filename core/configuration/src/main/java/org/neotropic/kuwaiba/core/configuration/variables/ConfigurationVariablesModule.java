 ...
 */
@Component
public class ConfigurationVariablesModule extends AbstractModule {
    /**
     * Module id.
     */
    public static final String MODULE_ID = "configuration/variables";
    /**
     * Translation service
     */
    @Autowired
    ...
    public String getName() {
        return ts.getTranslatedString("module.configman.name");
    }

    @Override
    public String getDescription() {
        return ts.getTranslatedString("module.configman.description");
    }
