...
public class DeleteValidatorDefinitionAction extends AbstractAction {   
    ...
    protected void init() {
        ...
        this.displayName = ts.getTranslatedString("module.configman.validators.actions.delete-validator.name");
        this.description = ts.getTranslatedString("module.configman.validators.actions.delete-validator.description");
        this.order = 1000;
        ...
        setCallback((parameters) -> {
            ...
            try {
                aem.deleteValidatorDefinition(validatorId, session.getUser().getUserName());
