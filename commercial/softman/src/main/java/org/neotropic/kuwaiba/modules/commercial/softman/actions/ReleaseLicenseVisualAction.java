...
public class ReleaseLicenseVisualAction extends AbstractVisualAction<Dialog> {
    ...
    public Dialog getVisualComponent(ModuleActionParameterSet parameters) {
        if (parameters.containsKey("license")) {
            ...
            ConfirmDialog wdwRelease = new ConfirmDialog(ts, this.releaseLicenseAction.getDisplayName(),
                    String.format(ts.getTranslatedString("module.softman.actions.release-license.confirm"), license.getName()),
