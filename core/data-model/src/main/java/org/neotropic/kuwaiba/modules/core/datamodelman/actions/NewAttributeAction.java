...
public class NewAttributeAction extends AbstractAction {
    ...
    @PostConstruct
    protected void init() {
        this.id = "datamodelman.new-attribute";
        this.displayName = ts.getTranslatedString("module.datamodelman.actions.new-attribute.name");
        this.description = ts.getTranslatedString("module.datamodelman.actions.new-attribute.name.description");
        this.order = 1000;
            
        setCallback((parameters) -> {
            String className = (String)parameters.get("className");
            String attributeName = (String)parameters.get("attributeName");
            String attributeDisplayName = (String)parameters.get("attributeDisplayName");
            String attributeType = (String)parameters.get("attributeType");           
            
            AttributeMetadata newAttribute = new AttributeMetadata();
