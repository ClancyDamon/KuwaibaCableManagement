 ...
 */
@Component
public class AddIpAddrToFolderAction extends AbstractAction {
    /**
     * Reference to the ip addres module service
     */
    @Autowired
    ...
    protected void init() {
        ...
        setCallback(parameters -> {
            try {
                ...
                ipamService.addIPAddressToFolder(parentOid, attributes);
