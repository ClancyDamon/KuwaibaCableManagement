 ...
 */
@Component
public class ProcessManagerModule extends AbstractCommercialModule {
    /**
     * The module id.
     */
    private static final String MODULE_ID = "processman"; //NOI18N
    /**
    ...
    public String getName() {
        return ts.getTranslatedString("module.processman.name");
    }
    ...
    public String getDescription() {
        return ts.getTranslatedString("module.processman.description");
    }
