 ...
 */
@Component
public class MoveObjectToWarehouseAction extends AbstractAction {
    /**
    ...
    @PostConstruct
    protected void init() {
        this.id = "whman.move-object-to-warehouse";
        this.displayName = ts.getTranslatedString("module.whman.actions.move-object-to-warehouse.name");
        this.description = ts.getTranslatedString("module.whman.actions.move-object-to-warehouse.description");
        this.order = 1000;
        ...
        setCallback(parameters -> {
            try {
                ...
                ws.moveObjectToWarehouse(pool.getId(), object.getClassName(), object.getId(), session.getUser().getUserName());
