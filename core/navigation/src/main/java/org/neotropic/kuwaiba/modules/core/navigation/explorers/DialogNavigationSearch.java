 ...
 */
public class DialogNavigationSearch extends Div {
    ...
    public DialogNavigationSearch(TranslationService ts, 
        ...
        txtSearch.setPlaceholder(ts.getTranslatedString("module.general.messages.search-by-name-or-class"));
