 ...
 */
@Component
public class CopyBusinessObjectToPoolVisualAction extends AbstractVisualInventoryAction implements ActionCompletedListener {
    /**
     ...
     */
    @Autowired
    private CopyBusinessObjectToPoolAction copyBusinessObjectToPoolAction;
    /**
    ...
    public CopyBusinessObjectToPoolVisualAction() {
        ...
        if (parameters.containsKey(PARAM_BUSINESS_OBJECT)) {
            try {
                ...
                wdwCopy = new ConfirmDialog(ts
                        , String.format(ts.getTranslatedString("module.pools.actions.copy-business-object-to-pool.header"), businessObject.toString())
                        , ts.getTranslatedString("module.general.labels.copy"));
                wdwCopy.setDraggable(true);
                wdwCopy.setResizable(true);
                ...
                List<InventoryObjectPool> pools = bem.getRootPools(null, ApplicationEntityManager.POOL_TYPE_GENERAL_PURPOSE, false);
                ...
                wdwCopy.getBtnConfirm().addClickListener(event -> {
                    try {
                        ActionResponse actionResponse =  copyBusinessObjectToPoolAction.getCallback().execute(new ModuleActionParameterSet(
                        ...
                        fireActionCompletedEvent(new ActionCompletedListener.ActionCompletedEvent(
                                ...
                                ts.getTranslatedString("module.pools.actions.copy-business-object-to-pool.success"),
                                CopyBusinessObjectToPoolAction.class,
                                actionResponse
                        ));
                        wdwCopy.close();
            ...
            return new Dialog(new Label(String.format(ts.getTranslatedString("module.general.messages.parameter-not-found"), PARAM_BUSINESS_OBJECT)));
        return null;
    }
    ...
    public AbstractAction getModuleAction() {
        return copyBusinessObjectToPoolAction;
    }
}