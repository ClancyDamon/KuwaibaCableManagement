 ...
 */
@Component
public class NewSubnetAction extends AbstractAction {
    /**
    ...
    @PostConstruct
    protected void init() {
        this.id = "ipam.new-subnet";
        this.displayName = ts.getTranslatedString("module.ipam.actions.add-subnet.name");
        this.description = ts.getTranslatedString("module.ipam.actions.add-subnet.description");
        ...
        setCallback(parameters -> {
            try {
                ...
                ipamService.createSubnet(parentOid, className, attributes);
