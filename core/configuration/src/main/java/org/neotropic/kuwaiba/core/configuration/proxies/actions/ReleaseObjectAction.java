...
public class ReleaseObjectAction extends AbstractAction {
    ...
    @PostConstruct
    protected void init() {
        this.id = "configman.release-object";
        this.displayName = ts.getTranslatedString("module.configman.proxies.actions.release-object.name");
        this.description = ts.getTranslatedString("module.configman.proxies.actions.release-object.description");
        ...
        setCallback((parameters) -> {
            ...
            try {
                pms.releaseObjectFromProxy(object.getClassName(), object.getId(),
