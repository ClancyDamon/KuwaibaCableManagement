...
public class DeleteTemplateAction extends AbstractAction {
    ...
    @PostConstruct
    protected void init() {
        this.id = "templateman.delete-template";
        this.displayName = ts.getTranslatedString("module.templateman.actions.delete-template.name");
        this.description = ts.getTranslatedString("module.templateman.actions.delete-template.description");
        this.order = 1000;
