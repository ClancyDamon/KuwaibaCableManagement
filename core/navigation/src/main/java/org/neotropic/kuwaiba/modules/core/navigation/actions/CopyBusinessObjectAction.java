 ...
 */
@Component
public class CopyBusinessObjectAction extends AbstractAction {
    /**
     ...
     */
    public static String PARAM_OBJECT_CLASS = "class"; //NOI18
    /**
     * Copy business object action parameter id.
     */
    public static String PARAM_OBJECT_ID = "id"; //NOI18
    /**
    ...
    @PostConstruct
    protected void init() {
        this.id = "navigation.copy-business-object"; //NOI18N
        this.displayName = ts.getTranslatedString("module.navigation.actions.copy-business-object.name");
        this.description = ts.getTranslatedString("module.navigation.actions.copy-business-object.description");
        this.icon = VaadinIcon.COPY_O.create();
        this.order = 4;
        setCallback(parameters -> {
            try {
                ...
                bem.copyObjects(targetClass, targetId, objects, true);
