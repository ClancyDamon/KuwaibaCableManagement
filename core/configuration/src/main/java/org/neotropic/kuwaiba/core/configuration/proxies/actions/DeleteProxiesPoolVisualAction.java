    ...
    public Dialog getVisualComponent(ModuleActionParameterSet parameters) {
        ...
        if (parameters.containsKey("pool")) {
            ...
            ConfirmDialog wdwDeletePool = new ConfirmDialog(ts, 
                    ...
                    String.format(ts.getTranslatedString("module.configman.proxies.actions.delete-pool.confirm"), selectedPool.getName()),
            ...
            return new Dialog(new Label(ts.getTranslatedString("module.configman.proxies.actions.delete-pool.error-param")));
    }
