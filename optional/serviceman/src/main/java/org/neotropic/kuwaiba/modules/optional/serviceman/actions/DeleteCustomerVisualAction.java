 ...
 */
@Component
public class DeleteCustomerVisualAction extends AbstractVisualAdvancedAction {
    /**
    ...
    public Dialog getVisualComponent(ModuleActionParameterSet parameters) {
        ...
        if (parameters.containsKey(PARAMETER_CUSTOMER)) {
            customer = (BusinessObjectLight) parameters.get(PARAMETER_CUSTOMER);
            ConfirmDialog wdwDeleteCustomer = new ConfirmDialog(ts,
                    this.deleteCustomerAction.getDisplayName(),
            ...
            wdwDeleteCustomer.setDraggable(true);
            ...
            wdwDeleteCustomer.getBtnConfirm().addClickListener(event -> {
                try {
                    this.deleteCustomerAction.getCallback()
                            .execute(new ModuleActionParameterSet(new ModuleActionParameter<>(PARAMETER_CUSTOMER, customer)));
            ...
            return new Dialog(new Label(ts.getTranslatedString("module.serviceman.actions.delete-customer.ui.customer-error")));
        }
    }
