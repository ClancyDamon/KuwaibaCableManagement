 ...
 */
@Component
public class RelateObjectToContractAction extends AbstractAction {
    /**
    ...
    */
    ...
    @PostConstruct
    protected void init() {
        this.id = "contract.relate-object";
        this.displayName = ts.getTranslatedString("module.contractman.actions.relate-object-to-contract.name");
        this.description = ts.getTranslatedString("module.contractman.actions.relate-object-to-contract.description");
        ...
        setCallback((parameters) -> {
            ...
            try {
                cms.relateObjectToContract(contract.getClassName()
                        , contract.getId()
                        , object.getClassName()
                        , object.getId()
                        , session.getUser().getUserName());
            } catch (MetadataObjectNotFoundException | InvalidArgumentException | BusinessObjectNotFoundException
