...
public class NewPhysicalConnectionWizard extends Wizard {
    ...
    public GeneralInfoStep(BusinessObjectLight rootASide, BusinessObjectLight rootBSide, BusinessEntityManager bem, 
            ...
            cmbConnectionType = new ComboBox<>(ts.getTranslatedString("module.visualization.connection-wizard-connection-type"), Arrays.asList(new ConnectionType(1, "Connect Using a Container"), connUsingLink));
