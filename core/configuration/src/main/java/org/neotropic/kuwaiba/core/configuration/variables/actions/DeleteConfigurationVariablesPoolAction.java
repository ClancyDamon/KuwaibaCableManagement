...
public class DeleteConfigurationVariablesPoolAction extends AbstractAction {
    ...
    protected void init() {
        ...
        this.displayName = ts.getTranslatedString("module.configman.actions.delete-configuration-variable-pool.name");
        this.description = ts.getTranslatedString("module.configman.actions.delete-configuration-variable-pool.description");
        this.order = 1000;
        ...
        setCallback((parameters) -> {
            ...
            try {
                aem.deleteConfigurationVariablesPool(poolId, session.getUser().getUserName());
