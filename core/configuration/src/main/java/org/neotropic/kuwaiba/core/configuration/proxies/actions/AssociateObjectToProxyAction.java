 ...
 */
@Component
public class AssociateObjectToProxyAction extends AbstractAction {
    /**
    ...
    @PostConstruct
    protected void init() {
        this.id = "configman.associate-object";
        this.displayName = ts.getTranslatedString("module.configman.proxies.actions.associate-object-to-proxy.name");
        this.description = ts.getTranslatedString("module.configman.proxies.actions.associate-object-to-proxy.description");
        ...
        setCallback((parameters) -> {
            ...
            try {
                pms.associateObjectToProxy(object.getClassName(), object.getId()
