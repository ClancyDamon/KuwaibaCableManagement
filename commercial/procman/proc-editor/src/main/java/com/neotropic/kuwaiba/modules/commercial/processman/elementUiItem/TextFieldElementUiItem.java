 ...
 */
public class TextFieldElementUiItem extends AbstractElementUiItem {

    public TextFieldElementUiItem(String displayName) {
        super(displayName);
    }
    ...
    public ElementUi create() {
        ...
        textFieldElementUi.setElementUiId(UUID.randomUUID().toString());
        textFieldElementUi.setElementUiWidth("30%");
        textFieldElementUi.setElementUiMinWidth("30px");
        textFieldElementUi.setElementUiHeight("33px");
        
        return textFieldElementUi;
    }
}