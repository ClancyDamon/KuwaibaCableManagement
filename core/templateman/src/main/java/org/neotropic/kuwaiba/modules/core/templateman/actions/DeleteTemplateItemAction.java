 ...
 */
@Component
public class DeleteTemplateItemAction extends AbstractAction {
    ...
    @PostConstruct
    protected void init() {
        this.id = "templateman.delete-template-item";
        this.displayName = ts.getTranslatedString("module.templateman.actions.delete-template-item.name");
        this.description = ts.getTranslatedString("module.templateman.actions.delete-template-item.description");
        this.order = 1000;
