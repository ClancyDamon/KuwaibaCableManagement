 ...
 */
@Component
public class PoolsModule  extends AbstractModule {
    /**
     * Module id.
     */
    public static String MODULE_ID = "pools";
    /**
    ...
    public void init() {
        ...
        // Core actions
        this.actionRegistry.registerAction(getId(), actCopyToPool);
        this.actionRegistry.registerAction(getId(), actMoveToPool);
    }
    ...
    */
    ...
    public String getName() {
        return ts.getTranslatedString("module.pools.name");
    }

    @Override
    public String getDescription() {
        return ts.getTranslatedString("module.pools.description");
    }
